...
#export pcornet_cdm=*****   # do this manually with set +o history

export i2b2_data_schema=BLUEHERONDATA
export i2b2_meta_schema=BLUEHERONMETADATA
export datamart_id=C4UTHSCSA
export datamart_name='UT HSC San Antonio'
export network_id=C4
export network_name=GPC
export i2b2_etl_schema=ETL
export min_pat_list_date_dd_mon_rrrr='01-Jan-2010'
export min_visit_date_dd_mon_rrrr='01-Jan-2010'
export enrollment_months_back=36

# All i2b2 terms - used for local path mapping
export terms_table=HERON_TERMS

python load_csv.py harvest_local harvest_local.csv harvest_local.ctl pcornet_cdm_user pcornet_cdm sid
